local Update = loadstring(Game:HttpGet"https://raw.githubusercontent.com/SHINXHUB/CopyCFrame/main/%E0%B9%84%E0%B8%A1%E0%B9%88%E0%B8%A1%E0%B8%B5%E0%B8%8A%E0%B8%B7%E0%B9%88%E0%B8%AD.txt")()
local Alert = loadstring(Game:HttpGet"https://pastebin.com/raw/nfg5ETq7")()
...
Main:Label("Leak script now !!!")
Main:Button("Copy Discord Link",function()
setclipboard("Mangoman on top") 
end)
        ...
        pcall(function()
            while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
                    Mirragecheck:Set('๐๏ธ Mirage Island is Spawning')
                    _G.MirageSpawn = true
                else
                    Mirragecheck:Set('๐๏ธ Mirage Island Not Spawn') 
                    _G.MirageSpawn = false
                 end
      
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
                    Kitsunecheck:Set('โฉ๏ธ Kitsune Island is Spawning')
                    _G.KitsuneSpawn = true
                else
                    Kitsunecheck:Set('โฉ๏ธ Kitsune Island Not Spawn') 
...
S:Button("Buy Boat",function()
    ...
    S:Button("Buy Dragon Claw [ ฦ’1,500 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    ...
    S:Button("Buy Death Step [ ฦ’5,000 $5,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:Button("Buy Sharkman Karate [ ฦ’5,000 $2,500,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:Button("Buy Electric Claw [ ฦ’5,000 $3,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:Button("Buy Dragon Talon [ ฦ’5,000 $3,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:Button("Buy God Human [ ฦ’5,000 $5,000,000 ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)

    S:Button("Buy Sanguine Art [ ฦ’5,000 $5,000,000 ]",function()
    ...
    S:Button("Pole v.2 [ ฦ’5,000 ]",function()
    ...
    S:Button("Kabucha [ ฦ’1,500]",function()
...
S:Button("Reset Stats [ Use ฦ’2,500 ]", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:Button("Random Race [ Use ฦ’3000 ]", function()
