...
local Window = Fluent:CreateWindow({
    ...
    Acrylic = true, -- อาจตรวจจับความเบลอได้ การตั้งค่านี้เป็นเท็จจะทำให้ความเบลอไม่ปรากฏขึ้นเลย
    Theme = "Darker",
    MinimizeKey = Enum.KeyCode.End -- ใช้เมื่อไม่มี MinimizeKeybind
})
local Tabs = {
...
ImageButton.Image = "rbxassetid://18804983248"
