...
spawn(function()
    while _G.Click do
        ...
        wait(0.0005) -- 20 ครั้งต่อวินาที (1 วินาที / 20 = 0.05)
    end
end)
                        ...
                        if enemy then
                            repeat
                                if enemy and enemy:FindFirstChild("Humanoid") and enemy:FindFirstChild("HumanoidRootPart") and enemy.Humanoid.Health > 0 then
                                    TW(enemy:FindFirstChild("HumanoidRootPart").CFrame * CFrame.new(0, 40, 0))
                                    game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                else
                                    Char.HumanoidRootPart.CFrame = questData.CFrameMon * CFrame.new(0, 40, 0)
                                end
                                wait(1)
